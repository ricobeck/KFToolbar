...
Pod::Spec.new do |s|
  ...
  #                  DESC
  # s.homepage     = "http://EXAMPLE/KFDropView"
  ...
  # s.authors      = { "Gunnar Herzog" => "gunnar.herzog@kf-interactive.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Gunnar Herzog', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://kfi.codebasehq.com/kftoolbar/kftoolbar.git", :tag => "0.0.5" }
